...
**国内用户**：可搭配 [火山方舟 Coding Plan](https://www.volcengine.com/L/s3lNTNYxaEc/)（[配置指南](/guides/cline-ark-setup)）使用，通过方舟中转 API 以较低门槛实现国内直连，活动价以官网为准。

### OpenCode

- 软件本身免费开源
- 费用取决于所用 API
- 搭配 [火山方舟 Coding Plan](https://www.volcengine.com/L/s3lNTNYxaEc/)：官网活动价
