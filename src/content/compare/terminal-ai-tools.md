...
**国内用户**：可搭配 [火山方舟 Coding Plan](https://volcengine.com/L/GHwMUAPkBr0/)（[配置指南](/guides/cline-ark-setup)）使用，¥9.9/月，通过方舟中转 API 大幅降低成本。

### OpenCode

- 软件本身免费开源
- 费用取决于所用 API
- 搭配 [火山方舟 Coding Plan](https://volcengine.com/L/GHwMUAPkBr0/)：¥9.9/月起
