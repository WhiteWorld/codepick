...
**For users in China**: Can be paired with [Volcengine Ark Coding Plan](https://www.volcengine.com/L/s3lNTNYxaEc/) ([setup guide](/guides/cline-ark-setup)) for a lower-entry China-direct setup, with promos changing on the official site.

### OpenCode

- The software itself is free and open source
- Costs depend on which API you use
- Paired with [Volcengine Ark Coding Plan](https://www.volcengine.com/L/s3lNTNYxaEc/): official promo pricing
