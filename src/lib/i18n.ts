...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'cluster.plans':         { zh: '方案与成本', en: 'Plans & Cost' },
  'cluster.workflow':      { zh: '工作流与协作', en: 'Workflows & Collaboration' },
  'cluster.tools':         { zh: '工具上手', en: 'Tool Setup' },
  'cluster.stack':         { zh: '开发实践', en: 'Dev Practices' },
  'cluster.market':        { zh: '市场观察', en: 'Market Notes' },
