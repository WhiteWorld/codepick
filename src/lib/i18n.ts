...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'conversion.plansTitle': { zh: '💰 相关省钱方案', en: '💰 Related money-saving plans' },
  'conversion.plansDesc':  { zh: '基于本文涉及的工具与 API，这些组合能帮你以更低成本上手。', en: 'Based on the tools and APIs in this guide — get started for less.' },
  'conversion.dealsTitle': { zh: '🎁 领取优惠 & 免费试用', en: '🎁 Grab deals & free trials' },
  'conversion.dealsDesc':  { zh: '汇总各工具与 Coding Plan 的免费额度、首月折扣与注册入口，随时更新。', en: 'Free quotas, first-month discounts, and sign-up links for tools & coding plans — kept up to date.' },
  'conversion.dealsCta':   { zh: '查看优惠福利 →', en: 'View all deals →' },
  ...
  'home.heroTitleNew':     { zh: 'AI 编程省钱 · 国内接入 · 计费解读', en: 'AI Coding — Save Money, China Access, Billing Decoded' },
  'home.heroSubtitle':     { zh: '面向中国开发者的 AI 编程省钱与接入指南', en: 'Practical guides to use AI coding tools cheaper, in China, with clear billing' },
  ...
  'guides.jumpTo':         { zh: '快速跳转', en: 'Jump to' },
  'cluster.coding-plan':   { zh: '省钱 & Coding Plan', en: 'Save Money & Coding Plans' },
  'cluster.china-billing': { zh: '国内访问 & 计费', en: 'China Access & Billing' },
  'cluster.setup':         { zh: '接入 & 配置教程', en: 'Setup & Config' },
  'cluster.updates':       { zh: '工具动态 & 科普', en: 'Updates & Concepts' },
  'cluster.agent-collab':  { zh: 'Agent 协作平台', en: 'Agent Collaboration' },
  'cluster.other':         { zh: '其他', en: 'More' },
  ...
  'codingPlan.apiPlansTitle':  { zh: '🔥 Coding / Agent Plan 订阅推荐', en: '🔥 Recommended Coding / Agent Plan APIs' },
  'codingPlan.apiPlansDesc':   { zh: '国内主流 AI 编程与 Agent 订阅服务，覆盖编程、Agent、多模态、多坐席等场景，价格与活动以官网为准', en: 'Mainstream China-native AI coding & Agent subscriptions covering coding, agents, multimodal and multi-seat use cases. Pricing and promos vary, check official sites.' },
